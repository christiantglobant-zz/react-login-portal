...
class RegisterPage extends Component {
  ...
  handleSubmit(event) {
    ...
    const { user } = this.state;
    if (user.username && user.password) this.props.register(user);
  }
...
const successfullyConnectedRegisterPage = connect(
  mapStateToProps,
  actionCreators
)(RegisterPage);

export { successfullyConnectedRegisterPage as RegisterPage };
